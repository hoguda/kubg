	...
	<section id="container">
		...
		<div id="container_box">
			<form role="form" method="post" autocomplete="off" enctype="multipart/form-data">
				...
				<div class="inputArea">
					<button class="btn btn-primary" type="submit" id="update_Btn">완료</button>
					<button class="btn btn-warning" type="button" id="back_Btn">취소</button>
				</div>
			</form>
		</div>
...
// 1차 분류 셀럭트 박스에 데이터 삽입
var cateSelect = $("select.category1");

for(var i = 0; i < cateArr.length; i++){
	cateSelect.append(
		"<option value='" + cateArr[i].cateCode + "'>"+ cateArr[i].cateName+"</option>"
	);
}
